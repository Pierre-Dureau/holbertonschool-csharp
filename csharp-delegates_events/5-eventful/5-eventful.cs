...
public class Player
{
    ...
    /// <summary> Displays a warning message based on the current health value. </summary>
    /// <param name="sender">The object that triggered the event.</param>
    /// <param name="e">An instance of the CurrentHPArgs class containing information about the current health status.</param>
    ...
    /// <summary> Handles the event triggered when checking the current health status. </summary>
    /// <param name="e">An instance of the CurrentHPArgs class containing information about the current health status.</param>
